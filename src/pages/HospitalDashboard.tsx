...
// Notification toggle with clear ON/OFF labeling
const NotificationToggle = ({
  ...
  return (
    <div className="flex items-center justify-between p-3 rounded-lg bg-secondary/40 gap-4">
            ...
            <div className="grid lg:grid-cols-2 gap-6">
              ...
              <Card className="shadow-card">
                <CardHeader>
                  ...
                  <CardDescription>Hospital Mode: receive alerts and request updates</CardDescription>
                </CardHeader>
                <CardContent className="space-y-3">
                  {[
                    { id: "donorAcceptances", label: "Donor Acceptances", desc: "Notify when donors accept requests" },
                    { id: "requestUpdates", label: "Request Updates", desc: "Status changes on blood requests" },
                    { id: "dailySummary", label: "Daily Summary", desc: "Daily digest of activity" },
                  ].map((item) => (
                    <NotificationToggle key={item.id} label={item.label} description={item.desc} />
                  ))}
                </CardContent>
              </Card>
            </div>
