...
// Mock nearby centers - in production, this would come from your backend/Google Places API
const getMockNearbycenters = (lat: number, lng: number): DonationCenter[] => [
  {
    id: "1",
  ...
  const requestLocation = useCallback(() => {
    ...
    navigator.geolocation.getCurrentPosition(
      (position) => {
        ...
        // Get nearby centers (mock data for now)
        const nearbyCenters = getMockNearbycenters(latitude, longitude);
        setCenters(nearbyCenters);
        setIsLoading(false);
        toast.success("Location found! Showing nearby donation centers.");
      },
      (err) => {
